...
public class ControllerMain {
    ...
    public void initKeepAlive(){
    	...
    	timerThread = new KeepAliveTimerThread();
		timerThread.start();
    }
    ...
    public void work() {
        ...
        RCSClient rcsClient = new RCSClient("127.0.0.1", 10000, table, config, timerThread);
        new Thread(rcsClient).start();
        //AppClient appClient = new AppClient("192.168.10.17", 9000, table, config, timerThread);
